...
| Class | Benchmark | ns/op | ops/s | B/op | allocs/op |
|:------|:----------|-----:|-----:|-----:|---------:|
| Core | `ResolveTopic` | 158.9 | 6293266 | 96 | 6 |
| Core | `NewRegisteredHandler` | 187.0 | 5347594 | 96 | 6 |
| Core | `PublishNoSubscribers` | 215.4 | 4642526 | 104 | 7 |
| Core | `PublishOneSubscriber` | 372.4 | 2685285 | 336 | 10 |
| Core | `PublishMultipleSubscribers` | 850.5 | 1175779 | 1000 | 16 |
| Integration | `DistributedPublishRoundTrip/nats` | 310000.0 | 3226 | 3232 | 56 |
<!-- bench:embed:end -->
...
- `sh docs/watcher.sh` reruns the docs update loop locally
